...
export default function HireForm() {
  ...
  return (
    <div className="relative h-full w-screen overflow-hidden bg-black">
      <div
        className={`${poppins.className} flex flex-col text-white justify-center`}
      >
          ...
          <div className="md:w-1/3 w-full h-full">
            <div>
              <div className="flex flex-col justify-center items-center pt-10 w-full h-full">
                ...
                {/* project details */}
                <h1 className="font-light text-2xl mb-6 pb-5 mt-10">
                  Project Details
                </h1>
                <div className="w-full mt-5 md:px-0 px-6">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    required
                    className="cursor-none mt-1 block w-full py-2 px-2 bg-black border border-white shadow-sm focus:outline-none text-white"
                ...
                <div className="w-full mt-5 md:px-0 px-6">
                  <div className="">
                    <label className="cursor-none block text-md font-medium text-white mb-1">
                      Service Type
                    </label>
                  </div>
                  <select
                    ...
                    required
                    className="cursor-none mt-4 block w-full py-2 bg-black border border-white focus:outline-none text-white"
                  >
