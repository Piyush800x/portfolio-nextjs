                ...
                <div className="flex flex-col justify-center items-center bg-black">
                    ...
                    <div className={inter.className}>
                        ...
                        <div className='flex flex-row justify-center items-center gap-5 font-medium text-lg mb-8'>
                            <Link href='/' className="border-2 hover:border-white bg-white text-black py-2 px-4 rounded-full hover:bg-black hover:text-white transition ease-in-out duration-300 ">CONTACT ME</Link>
                            <Link href='/' className="border-2 border-white bg-black text-white py-2 px-4 rounded-full hover:bg-white hover:text-black transition ease-in-out duration-300 ">VIEW PROJECTS</Link>
                        </div>
                    </div>
                </div>
            </div>
